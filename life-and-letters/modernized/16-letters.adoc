...
your dear father replied, "`_Yours_ was not broken: it was a good meeting,
and ended well.`"
...
and I _have not heard anything else._
...
or as you properly style it, "`murmuring:`" who knows, but if we do so,
...
and does not withhold any _good_ thing`"--anything that is really good for us.

Let us, as you say, "`number our remaining blessings;`" yes, may we not forget--
