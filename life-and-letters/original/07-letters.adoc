...
whilst this all tells us that our rest is not _here,_ what a consolatory reflection, that,
...
+++_______+++ told me, among other things, that thou wast "`_gooder_`" than myself.
